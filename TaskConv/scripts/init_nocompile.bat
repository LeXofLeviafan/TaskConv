...
@rem easy_install scripts\winxp\future-0.18.2-py3-none-any.whl
@rem scripts\winxp\unzip scripts\winxp\pywin32-221
@rem (cd pywin32-221 & python setup3.py install & cd ..)
@rem rmdir /S /Q pywin32-221
@rem easy_install scripts\winxp\pypiwin32-221-py3-none-any.whl
@rem easy_install scripts\winxp\PyInstaller-3.2.1-py3-none-any.whl
if /I %0 == "%~dpnx0" pause
exit /B
